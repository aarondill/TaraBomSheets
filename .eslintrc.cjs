// @ts-check
/** @typedef {import("./node_modules/@typescript-eslint/utils/dist/ts-eslint/Linter.d.ts").Linter.Config} EslintConfig */
/** @typedef {import("./node_modules/@typescript-eslint/utils/dist/ts-eslint/Linter.d.ts").Linter.Config["ignorePatterns"]} EslintIgnorePatterns */
/** @typedef {import("./node_modules/@typescript-eslint/utils/dist/ts-eslint/Linter.d.ts").Linter.RulesRecord} EslintRules */
/** @typedef {import("./node_modules/@typescript-eslint/utils/dist/ts-eslint/Linter.d.ts").Linter.ConfigOverride} ConfigOverride */
